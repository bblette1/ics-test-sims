...
for (j in c(100)) {
  ...
  for (k in 1:9) {
    ...
    for (i in 1:nsims) {
      ...
      # Simulate potential outcomes with ICC = 0.01
      ICC <- 0.01
      Y_resvar <- 1
